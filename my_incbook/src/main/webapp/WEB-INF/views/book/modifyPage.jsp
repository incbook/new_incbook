						...
						<div class="account__form" style="border-color: red">
							...
							<div class="input__box">
								<label for="genre">장르 <span>*</span></label> <select id="genre"
									name="genre" value="${modifyTarget.genre}" style="height: 30px;" >
							...
							<div class="input__box">
								...
								<textarea name="content" rows="7" cols="50">${modifyTarget.content}</textarea>
							</div>

							<div class="input__box">
								<label for="image">이미지 <span>*</span></label> <input type="text"
									name="image" value="${modifyTarget.image}">
							</div>
